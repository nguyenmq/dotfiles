...
call <sid>hi("LineNr",        s:gui02, s:gui0E, s:cterm02, s:cterm0E, "none")
call <sid>hi("LineNrAbove",   s:gui02, s:gui0F, s:cterm02, s:cterm0F, "none")
call <sid>hi("LineNrBelow",   s:gui02, s:gui0F, s:cterm02, s:cterm0F, "none")
call <sid>hi("SignColumn",    s:gui03, s:gui01, s:cterm03, s:cterm01, "")
call <sid>hi("StatusLine",    s:gui02, s:gui02, s:cterm02, s:cterm02, "none")
call <sid>hi("StatusLineNC",  s:gui0D, s:gui02, s:cterm0D, s:cterm02, "none")
...
call <sid>hi("Search",        s:gui00, s:gui11, s:cterm00, s:cterm11,  "")
...
call <sid>hi("Error",           s:gui0F, s:gui01, s:cterm0F, s:cterm01, "")
...
" CtrlP highlighting
call <sid>hi("CtrlPBufferNr",     s:gui06, "", s:cterm06, "", "")
call <sid>hi("CtrlPBufferInd",    "", "", "", "", "")
call <sid>hi("CtrlPBufferHid",    s:gui00, "", s:cterm00, "", "")
call <sid>hi("CtrlPBufferHidMod", s:gui00, "", s:cterm00, "", "")
call <sid>hi("CtrlPBufferVis",    s:gui00, "", s:cterm00, "", "")
call <sid>hi("CtrlPBufferVisMod", s:gui01, "", s:cterm01, "", "bold")
call <sid>hi("CtrlPBufferCur",    s:gui00, "", s:cterm00, "", "")
call <sid>hi("CtrlPBufferCurMod", s:gui01, "", s:cterm01, "", "bold")
call <sid>hi("CtrlPBufferPath",   s:gui05, "", s:cterm05, "", "")
