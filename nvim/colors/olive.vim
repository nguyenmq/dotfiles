...
call <sid>hi("FoldColumn",    "{{ui_text_accent}}", "{{ui_accent}}", s:cterm0E, s:cterm02, "")
call <sid>hi("Folded",        "{{blue}}", "{{white}}", s:cterm04, s:cterm0E, "")
...
call <sid>hi("Normal",        "{{black}}", "{{white_almost}}", "", "", "none")
call <sid>hi("LineNr",        "{{ui_primary}}", "{{white}}", s:cterm02, s:cterm0E, "none")
call <sid>hi("LineNrAbove",   "{{ui_primary}}", "{{gray_light}}", s:cterm02, s:cterm0F, "none")
call <sid>hi("LineNrBelow",   "{{ui_primary}}", "{{gray_light}}", s:cterm02, s:cterm0F, "none")
call <sid>hi("SignColumn",    "{{ui_primary}}", "{{gray_light}}", s:cterm03, s:cterm01, "")
