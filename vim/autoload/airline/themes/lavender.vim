...
function! airline#themes#lavender#refresh()
    ...
    let s:NORM2 = [ '#ffffff', '#2bb24c', '00', '03' ]
    let s:NORM3 = [ '#000000', '#eeeeee', '231', '06' ]
    ...
    let s:IN1 = [ '#875faf', '#eeeeee', '00', '03' ]
    let s:IN2 = [ '#875faf', '#eeeeee', '00', '03' ]
    let s:IN3 = [ '#875faf', '#eeeeee', '231', '03' ]
